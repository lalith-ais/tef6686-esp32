...
static esp_err_t tef_crystal_init_9216(void)
{
    ...
    // Entry 2: [9 bytes] 0x40 0x04 0x01 0x00 0x8C 0xA0 0x00 0x00 0x00
    // APPL_Set_ReferenceClock for 9.216 MHz
    uint8_t clk[] = { 0x40, 0x04, 0x01, 0x00, 0x8C, 0xA0, 0x00, 0x00, 0x00 };
